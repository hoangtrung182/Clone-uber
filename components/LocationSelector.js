...
const style = {
    wrapper: 'pt-2',
    searchHeader: 'w-full font-bold text-left flex item-center text-3xl p-4 overflow-hidden',
    inputBoxes: 'flex flex-col mb-4 relative',
    inputBox: 'h-10 px-4 border-2 bg-[#eeeeee] flex items-center my-1 py-1 px-2',
    focusedInputBox: 'border-black',
    svgContainer: 'mx-1',
    input: 'my-2 rounded-2 p-2 outline-none border-none bg-transparent h-full w-full',
    verticalLine: 'w-0 h-[2rem] border-black border absolute z-10 left-[1.3rem] top-[2rem]',
}
        ...
        <div className={style.inputBoxes}>
            <div className={`${style.inputBox} ${inFocus === 'from' && style.focusedInputBox}`}>
                ...
                <input className={style.input} 
                        placeholder='Enter a location from' 
                        value={pickup} 
            ...
            <div className={`${style.inputBox} ${inFocus === 'to' && style.focusedInputBox}`}>
                ...
                <input className={style.input} 
                        placeholder='Enter a location to'  
                        value={dropoff} 
